...
```html
<h2 class="mb-8 border-b border-stone-200 pb-3 font-mono text-base font-medium
...
| `letter-spacing` | `0.04em`（desktop） | 微細な字間調整。詰めすぎず、緩めすぎない |
...
<div class="rounded-lg border border-stone-200 bg-white
            dark:border-stone-800 dark:bg-stone-900 p-6">
```

### Primary Button

```html
<a class="inline-flex items-center rounded px-4 py-2 text-white transition-colors hover:opacity-80"
...
```html
<a class="inline-flex items-center rounded border border-stone-300 px-4 py-2
...
<!-- inactive -->
<div class="bg-white border border-stone-200 hover:bg-stone-100 ...">
```
