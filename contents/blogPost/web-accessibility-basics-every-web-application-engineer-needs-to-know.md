...
ユーザビリティとアクセシビリティはよく似た意味の言葉です。この2つの言葉の関係・違いは何でしょうか？端的に述べると、アクセシビリティはユーザビリティの土台となるものだと考えることができます。
...
このコードのアクセシビリティの問題点として、キーボードで操作している際に同じ要素に2回フォーカスされてしまうという点があります。
