...
実際に payments-api 障害対応ワークフローを実行した結果のトレースを可視化してみると、以下のようになりました。どのツールが呼び出されているのか、どの処理に時間がかかっているのか一目瞭然ですね。

![](https://images.ctfassets.net/in6v9lxmm5c8/2inicmt7coh04eMuNiEC3v/ef64876af243eb5516176677f9f8b231/image.png)
