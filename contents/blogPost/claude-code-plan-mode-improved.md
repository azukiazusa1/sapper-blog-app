...
プランモードの改善点は主に以下の 3 つです。

1. プランの計画に専用のサブエージェントを使用するようになった
2. 不明な点をユーザーに確認する機能が追加された
3. 計画をファイルに保存し、より詳細な仕様書のような体裁になった

この記事では、Claude Code のプランモードの改善点について紹介します。

## プランの計画に専用のサブエージェントを使用
