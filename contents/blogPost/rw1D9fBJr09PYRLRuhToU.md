...
<details>
<summary>`app/actions/board.ts`</summary>

```typescript:app/actions/board.ts
"use server"
        ...
        <div className="max-w-2xl mx-auto text-center space-y-8">
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground text-lg">
              新しいKanbanボードを作成して、タスクを効率的に管理しましょう
            </p>
          </div>
...
<details>
<summary>`components/board-creation-dialog.tsx`</summary>

```tsx:components/board-creation-dialog.tsx
"use client"
...
<details>
<summary>`app/boards/[boardId]/page.tsx`</summary>

```tsx:app/boards/[boardId]/page.tsx
...
<details>
<summary>`components/board-list.tsx`</summary>

```tsx:components/board-list.tsx
...
<details>
<summary>`app/actions/task.ts`</summary>

```typescript:app/actions/task.ts
"use server";
...
<details>
<summary>`components/task-creation-dialog.tsx`</summary>

```tsx:components/task-creation-dialog.tsx
"use client";
...
<details>
<summary>`lib/priority.ts`</summary>

```typescript:lib/priority.ts
import { Priority } from "@prisma/client";
