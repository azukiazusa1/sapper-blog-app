...
<!-- 
しかし、AI によって見かけ上は動作するコードが書けてしまうと、実際のスキルが伴わないまま表面的な成果だけが得られることになります。従来の学習曲線ですとちょうどプラトー期間の手前ぐらいのスキルが得られたように見えますが、実際には基礎が伴っていないため、応用や熟練の段階に進んだ際に深い理解が得られません。この乖離は非常に深刻な問題です。
 -->
