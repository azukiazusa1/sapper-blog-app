...
- 参考書籍: [習慣の力〔新版〕 (ハヤカワ文庫NF)](https://www.hayakawa-online.co.jp/shop/g/g0000612738/)
- 始めは小さく始める
  - 自分も始めは週報から始まった
...
- 習慣の3つの要素
  1. きっかけ: 行動を始めるためのトリガー
  - Xのタイムラインを眺めて興味を持った記事を読む
  - 記事を書く障害を下げる
    - エディタをすぐ開けるようにしておく
  2. ルーティン: 日常の一部として行う行動
  - 週1回ブログを書く
  - 決まった時間に行うこと
  3. 報酬: 行動の後に得られる満足感
  - 報酬は自分でコントロールできるものにする
    - 記事を書き終えたあとの達成感
    - ブログを書き終えたら知識の整理ができてスッキリする
  - 他人からの反応はコントロールできないので、報酬にしない
    - いいねやコメントなど
