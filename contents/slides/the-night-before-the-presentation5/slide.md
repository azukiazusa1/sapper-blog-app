...
<!--
今日は「習慣×AI×環境 — 技術探求を続ける3つの鍵」というテーマで、話したいと思います。
-->
...
<!--
なにか物事を習慣化するというのは一見難しそうに思えますが、実は習慣化の仕組みを理解すれば誰でも習慣化することが可能です。ここではその基本的な仕組みについて説明します。
 -->
...
![w:500](./images/habit-loop-diagram.svg)
...
<!--
習慣化で重要なのは、いきなり大きな目標を立てるのではなく、小さな習慣を作ることです。大きな物事を達成するよりも継続を目指すことが大切です。私自身去年からランニングを始めましたが、最初は2〜3kmから始めて、継続したことで徐々に距離を伸ばして10km走れるようになりました。初めから10km走ろうとすると挫折しやすいですよね。
また、SNSのいいね数やアクセス数を報酬にしないことも重要です。他人からの反応はコントロールできないため、これを報酬にしてしまうと習慣が続かなくなるリスクがあります。
-->
...
# 技術記事を書く習慣が技術に取り残される不安を和らげる

<!--
私にとって、技術記事を書く習慣は技術に取り残される不安を和らげる重要な要素です。技術記事を書くことで、新しい技術に触れ続けることができ、また自分の理解を深めることができます。これにより、技術の進化に遅れを取ることなく、自信を持ってエンジニアリングのキャリアを築くことができます。
 -->
...
技術記事の執筆は人間がやるべきだが、AI を全く使わないのもナンセンス
...
- 自己ラベリングで自分自身のキャラを決めつけてしまうと、行動の幅が狭まってしまうという問題がある

<!--
自己ラベリングに縛られないでください。「私は〇〇だから」という思い込みを捨てることが第一歩です。

私自身もかつては「私は喋るのが苦手なキャラだから、登壇なんてできない」と思っていました。このように、自分自身のキャラを決めつけてしまった結果、そのラベルに沿った行動を取るようになってしまい、行動の幅を狭めてしまう現象を自己ラベリングと呼びます。
-->

---

## 自己ラベリングを脱却するには、環境を変える

<div class="flex">

<div>

- ラベルは生まれ育った環境によって形成され、社会的相互作用の中で維持される
- 環境を変えることで、自分の行動や思考パターンも変わる
- 私が所属している会社では登壇を推奨する文化があり、社内勉強会から始めて成功体験を積み重ねられた
...
<!--
私が自己ラベリングから脱却できたのは、環境を変えたことが大きかったです。自己のキャラクターは生まれ育った環境によって形成されると言われています。環境を変えることによって、自分の行動や思考パターンも変わるのです。例えば、高校デビューという言葉がありますが、これは高校という新しい環境に身をおいた結果、自分のキャラクターを再定義できた例です。

私が所属している会社では登壇を推奨する文化があり、まずは社内勉強会から始めて、意外とできるじゃんという成功体験を積み重ねることができました。環境を変えることで、自分の行動や思考パターンも変わるのです。

このあたりの話は、「移動する人はうまくいく」という書籍にも詳しく書かれているので、興味があればぜひ読んでみてください。
...
- 私自身 2025 年に初めてライブに参戦した

<!--
また、毎年新しいことを始めるのもおすすめです。人間は変化を嫌う生き物なので、新しいことを始めるのは負荷がかかる行為です。しかし、マンネリ化したルーティンを繰り返しても、脳はあまり刺激を受けません。新しいことに挑戦することで、自己理解を更新し、自分には向いてないと思ってたことに意外とハマったりすることもあります。例えば、私は2025年に初めてライブに参戦しました。新しい体験を通じて、自分の新たな一面を発見できました。
-->
