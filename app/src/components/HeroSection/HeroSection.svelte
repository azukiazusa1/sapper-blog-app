...
<section
  class="bg-gradient-to-br from-indigo-900 via-indigo-800 to-purple-900 dark:from-indigo-950 dark:via-indigo-900 dark:to-purple-950"
>
  <div
...
<style>
  ...
  .waving-hand {
    ...
    animation: wave 2.5s ease-in-out 1; /* Changed to play only once */
  }
</style>
