...
{#if count !== undefined}
  ...
  >
    <div class="h-full rounded-xl bg-white shadow-sm transition-all duration-300 hover:shadow-md overflow-hidden flex flex-col dark:bg-zinc-900 border border-gray-100 dark:border-zinc-800">
      <div class="bg-gradient-to-r {colorClass} p-3 flex items-center justify-center opacity-90">
        <span class="text-white text-base font-medium">#{name}</span>
      </div>
      <div class="p-4 flex-1 flex items-center justify-center">
        <div class="text-center">
          <span class="block text-xl font-bold text-gray-700 dark:text-gray-200">{count}</span>
