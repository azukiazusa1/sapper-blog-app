  ...
  <div class="mx-auto w-full max-w-2xl p-4 md:p-8">
    ...
    <div class="mt-8 flex max-w-2xl justify-between">
      <button
        ...
        class="inline-flex h-10 items-center justify-center gap-2 whitespace-nowrap rounded-md bg-black px-4 py-2 text-sm font-medium transition-colors hover:bg-gray-800 focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50"
      >
        Previous
      </button>
